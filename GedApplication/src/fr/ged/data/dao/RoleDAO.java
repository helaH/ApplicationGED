...
public class RoleDAO extends HibernateDaoSupport {
	...
	//property constants
	public static final String NOM_ROLE = "nomRole";
	...
	public List findByNomRole(Object nomRole) {
		return findByProperty(NOM_ROLE, nomRole);
	}
